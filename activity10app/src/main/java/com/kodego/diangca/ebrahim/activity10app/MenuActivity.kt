...
/**
Edit the Code in Activity 10

Create  3 tabs for the fragments

1st Tab - List
A fragment with a recycler view that will either show either students in the class, books in the library or items in the grocery

2nd Tab - Search
This contains a textbox where a user can input to search a student, book or a class

3rd Tab - Transaction
The user can create a list of students by category (using filter), a list of books to borrow or check out from grocery.
...
import com.kodego.diangca.ebrahim.activity10app.databinding.ActivityMenuBinding
import com.kodego.diangca.ebrahim.activity10app.model.*
