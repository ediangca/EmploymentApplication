...
import com.kodego.diangca.ebrahim.loginapplication.databinding.TransactionItemBinding
...
class TransactionAdapter(var mainActivity: MainActivity, var transactions: ArrayList<Transaction>) :
    ...
    inner class TransactionViewHolder(
        ...
        fun bindTransaction(transaction: Transaction) {
            ...
            itemBinding.borrowDetails.text = "${transaction.borrower!!.showDetails()} \n ${transaction.book!!.showDetails()}"
